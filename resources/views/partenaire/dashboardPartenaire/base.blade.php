...
<header class="bg-red-200 pb-5">
			...
			<aside class="z-10 bg-red-100 md:max-w-[250px] fixed bottom-0 left-0 right-0 md:top-24 md:right-auto overflow-x-auto  grouSp">
				<div class="flex justify-around items-cxenter md:flex-col cursor-pointer w-full min-w-max  uppercase font-semibold">
					<a href="" class="p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 border-black hover:bg-white min-w-max w-full hover:duration-1000"><i class="fa fa-bar-chart"></i><span class="md:hiddeWn group-hover:inline-block" >Caisse</span></a>
					...
					<a href="" id="index" class="target:bg-black target:shadow-lg p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 border-black hover:bg-white min-w-max w-full hover:duration-1000 "> <i class="fa fa-table"></i><span class="md:hidWden group-hover:inline-block group-hover:duration-[5s]">Tables</span></a>
					<a href="" id="elements" class="target:bg-black target:shadow-lg p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 border-black hover:bg-white min-w-max w-full hover:duration-1000"><i class="fa fa-list"></i><span class="md:hiddeWn group-hover:inline-block" >Elements</span></a>
					...
					<a href="" id="clients" class="target:bg-black target:shadow-lg p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 min-w-max w-full border-black hover:bg-white hover:duration-1000"><i class="fa fa-users"></i><span class="md:hiddWen group-hover:inline-block">Partenaires</span></a>
					<a href="" class="p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 border-black hover:bg-white min-w-max w-full hover:duration-1000"><i class="fa fa-thumbs-up"></i><span class="md:hWidden group-hover:inline-block">abonnements</span></a>
					<p class="p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 min-w-max w-full  border-black hover:bg-white hover:duration-1000"><i class="fa fa-comments"></i><span class="md:hidWden group-hover:inline-block">Contacts</span></p>
				</div>
			</aside>
		</header>
