...
<header class="bg-red-200 pb-5">
			...
			<aside class="z-10 bg-red-100 md:max-w-[250px] fixed bottom-0 left-0 right-0 md:top-24 md:right-auto overflow-x-auto  grouSp">
				<div class="flex justify-around items-cxenter md:flex-col cursor-pointer w-full min-w-max  uppercase font-semibold">
					<a href="{{ route('partenaires.commande.show', $restaurant) }}" class="p-3 grid grid-cols-1 place-content-center place-items-center rounded-lg border-x-2 md:border-x-0 md:border-y-2 min-w-max w-full border-black hover:bg-white hover:duration-1000"><i class="fa fa-shopping-cart"></i><span class="md:hiWdden group-hover:inline-block" >Commandes</span></a>
